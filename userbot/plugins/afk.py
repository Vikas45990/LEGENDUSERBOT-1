# by uniborg...Thanks @AdityaHalder
...
async def _(event):
    ...
    if not USER_AFK:  # pylint:disable=E0602
        ...
        if reason:
            ...
            await borg.send_message(event.chat_id, f"¦É'§Þ g¦Ï¦É§Úg ¦Á?¦Ê !?", file=LEGENDpic)
