        ...
        if event.query.user_id == bot.uid and query == "legendbot_help":
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [Button.url("📍 𝚁𝚎𝚙𝚘 📍", "https://github.com/LEGENDXOS/LEGENDBOT")],
                    [
                        Button.url(
                            "💞 Deploy 💞",
                            "https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FLEGENDXOS%2FLEGENDBOT&template=https%3A%2F%2Fgithub.com%2FLEGENDXOS%2FLEGENDBOT",
                        )
                    ],
                ],
            )
            ...
            result = builder.photo(
                ...
                buttons=[
                    [
                        custom.Button.url(
                            "⭐ Repo ⭐", "https://Github.com/LEGENDXOS/LEGENDBOT"
                        ),
                        custom.Button.url(
                            "⚡ Repl ⚡",
                            "https://replit.com/@LEGENDXOS/LEGENDBOT#main.py",
                        ),
                    ],
                ],
                link_preview=False,
