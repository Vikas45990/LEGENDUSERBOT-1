    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("Help Me ❓", "https://t.me/adityadiscus")],
                [Button.url("Github Repo ❓", "github.com/LEGENDXOS/LEGENDBOT")],
            ],
        )
...
async def users(event):
    if event.query.user_id == bot.uid:
        ...
        await event.answer(
            "Wait ... Sorry U are Not My Owner So, U Cant Acesss It",
            cache_time=0,
            alert=True,
        )
