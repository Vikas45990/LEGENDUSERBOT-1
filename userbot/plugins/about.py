...
pm_caption += f"┣Lêɠêɳ̃d  ~ [Owner](https://t.me/AdityaHalder)\n"
pm_caption += f"┣Support ~ [G𝖗ουρ](https://t.me/adityadiscus)\n"
pm_caption += f"┣Řepô    ~ [Rєρο](https://github.com/LEGENDXOS/LEGENDBOT)\n"
pm_caption += f"**╰────────────**\n"
