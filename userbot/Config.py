...
if ENV:
    ...
    class Config(object):
        ...
        G_BAN_LOGGER_GROUP = int(os.environ.get("G_BAN_LOGGER_GROUP", -1001290168831))
        ...
        YOUR_GROUP = os.environ.get("YOUR_GROUP", "@AdityaServer")
        YOUR_CHANNEL = os.environ.get("YOUR_CHANNEL", "@AdityaDiscus.")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/LEGENDXOS/LEGENDBOT"
        )
